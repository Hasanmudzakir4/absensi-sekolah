  ...
  void _loadProfile() async {
    ...
    if (user != null) {
      setState(() {
        ...
        _semesterController.text = user.studentSemester ?? '';
  ...
  void _saveProfile() async {
    ...
    if (firebaseUser != null) {
      ...
      UserModel userModel = UserModel(
        ...
        studentSemester: _semesterController.text,
      ...
      body: SingleChildScrollView(
        ...
        child: Column(
          children: [
            ...
            _buildTextField(_idNumberController, "NIM", Icons.badge),
            _buildTextField(_semesterController, "Semester", Icons.school),
            _buildTextField(_classController, "Kelas", Icons.class_),
            _buildTextField(
              _phoneController,
              "Telepon",
              Icons.phone,
